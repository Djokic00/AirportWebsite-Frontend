      ...
      <b-navbar toggleable="lg" type="dark" variant="dark">
        ...
        <b-collapse id="nav-collapse" is-nav>
          <b-navbar-nav>
            ...
            <b-nav-item to="/flight">Flights</b-nav-item>
            <b-nav-item to="/cargo">Cargo</b-nav-item>
            <b-nav-item to="/insurance">Insurance</b-nav-item>
            <b-nav-item to="/rentACar">Rent a Car</b-nav-item>
          </b-navbar-nav>
